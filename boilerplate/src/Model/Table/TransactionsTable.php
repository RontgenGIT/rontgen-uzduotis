...
class TransactionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('RelatedTransactions', [
            'className' => 'Transactions',
            'foreignKey' => 'related_transaction_id',
        ]);
        $this->belongsTo('RecipientWallets', [
            'className' => 'Wallets',
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('related_transaction_id')
            ->allowEmptyString('related_transaction_id');

        $validator
            ->integer('recipient_wallet_id')
            ->allowEmptyString('recipient_wallet_id');
