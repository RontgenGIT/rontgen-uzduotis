...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_email_index' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'email' => 'test@test.com',
                'password' => (new \Cake\Auth\DefaultPasswordHasher())->hash('test'),
                'created' => '2025-07-29 13:17:36',
                'modified' => '2025-07-29 13:17:36',
            ],
            [
                'id' => 2,
                'email' => 'test2@test.com',
                'password' => (new \Cake\Auth\DefaultPasswordHasher())->hash('test2'),
                'created' => '2025-07-29 13:17:36',
                'modified' => '2025-07-29 13:17:36',
            ],
        ];
